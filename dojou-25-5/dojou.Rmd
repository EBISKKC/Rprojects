...
![Soil Data Visualization Report](graph/dojou-r.png)
...
## 1.2 結果
![4/22検量線](graph/4-22.png)

<br>

上記の検量線を用いて、リン酸吸収係数を求めた、リン酸吸収係数は*2358.235254*となった。
リン酸アンモニウム液2.5%を作るための計算である。

![4/23検量線](graph/4-23.png)
<br>

上記の検量線を用いて、リン酸吸収係数を求めた、リン酸吸収係数は*759.3170224*となった。
<br>

## 1.3 考察

実験結果から、私たちの班の試料は褐色森林土A層であることが判明した。褐色森林土A層は、主に落葉広葉樹林などの森林地帯に分布し、土色が褐色で、比較的有機物が豊富だが、黒ボク土ほどではないのが特徴である。今回測定したpHはやや酸性で、CEC（陽イオン交換容量）は中程度という結果だった。これは、森林土壌に見られる特徴と一致しており、農地と比べて塩基飽和度がやや低いことも確認できた。これらの性質は、落葉や有機物の分解、降雨による塩基流亡など、森林特有の環境要因が影響していると考えられる。また、リン酸吸収係数もやや高めであり、リンが固定されやすいことも褐色森林土の特徴を反映していた。
